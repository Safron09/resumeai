...
CELERY_BROKER_USE_SSL = {'ssl_cert_reqs': _ssl.CERT_NONE} if _redis_url.startswith('rediss://') else None
CELERY_REDIS_BACKEND_USE_SSL = {'ssl_cert_reqs': _ssl.CERT_NONE} if _redis_url.startswith('rediss://') else None
